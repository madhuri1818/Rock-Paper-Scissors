...
const App = () => {
    ...
    if (userPoints <= 4 && computerPoints <= 4) {
      ...
      if (comboMoves === 'paperscissors' || comboMoves === 'scissorsrock' || comboMoves === 'rockpaper') {
        ...
        if (updatedComputerPoints === 5) {
          setResult('Computer Won,Try Again?')
          const gameOff = true
          setGameOver(gameOff)
        }
      }
  ...
  return (
    <div className="App">
      ...
      <h1 className='heading'> <div className='heading-conatiner'> Rock-Paper-Scissors</div></h1>
      <div className='score'>
      ...
      <div className='button-div'>
        {gameOver && 
          <button className='button' id='restart'onClick={() => reset()}>Restart Game?</button>
        }
     </div>
    </div>
    // </div>
